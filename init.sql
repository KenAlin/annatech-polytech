...
INSERT INTO "sections" VALUES ('ENR', 'Energ�tique - �nergies renouvelables', 'ENR.png', '98BF0E');
INSERT INTO "sections" VALUES ('GBA', 'G�nie biologique et agroalimentaire', 'STIA.png', '97A01B');
INSERT INTO "sections" VALUES ('MAT', 'Mat�riaux', 'MAT.png', '32B199');
INSERT INTO "sections" VALUES ('MI', 'M�canique et interactions', 'MI.png', 'B8491E');
INSERT INTO "sections" VALUES ('MEA', 'Micro�lectronique et automatique', 'MEA.png', '7C659F');
INSERT INTO "sections" VALUES ('STE', 'Sciences et technologies de l''eau', 'STE.png', '0E72B5');
INSERT INTO "sections" VALUES ('EGC', 'Eau et g�nie civil', 'EGC.png', 'EE7F01');
INSERT INTO "sections" VALUES ('MSI', 'M�canique structures industrielles', 'MSI.png', '7693A8');
INSERT INTO "sections" VALUES ('SE', 'Syst�mes embarqu�s', 'SE.png', '398697');

/*	Create table "UE" for "Unit�s d'Enseignement"
...
INSERT INTO "ue" (nom_ue, section, annee, semestre) VALUES ('Fondamentaux des Math�matiques', 'IG', '3', '5');
...
INSERT INTO "ue" (nom_ue, section, annee, semestre) VALUES ('Techniques de l''Ing�nieur', 'IG', '3', '6');
...
INSERT INTO "matieres" (nom_mat, id_ue, description) VALUES ('Algorithmique et structures de donn�es', '1', 'Coef tr�s haut, mati�re � ne surtout pas manquer !');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Architecture des ordinateurs et langage d''assemblage', '1');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Syst�mes d''Exploitation 1', '1');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('R�seaux', '1');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('UNIX', '1');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Math�matiques pour l''Informatique', '2');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Mod�lisation et statistiques', '2');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Math�matiques de la D�cision 1', '2');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Introduction aux SI', '3');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('ACSI', '3');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Culture �conomique et soci�tale', '3');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Comptabilit� des entreprises', '3');
INSERT INTO "matieres" (nom_mat, id_ue) VALUES ('Anglais', '3');
INSERT INTO "matieres" (nom_mat, id_ue, description) VALUES ('Intro architecture web', '4', 'Projet de fin d''ann�e tr�s important');
...
INSERT INTO "sujets" (titre, matiere, annee, correction, posteur, url) VALUES ('Corrig� algo 2015 officiel', 1, 2015, TRUE, 1, 'coralgo2015.pdf');
